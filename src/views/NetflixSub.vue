<template>
    <div class="subscribe-plans">
        ...
        <div class="subscribe-plans__description">Listen without limits at a bargain price</div>
        <div class="subscribe-plans__duration">
            <div @click="subscribeDuration = '6'" :class="{ 'duration-selected': subscribeDuration === '6' }" class="subscribe-plans__six-month">6 months</div>
            <div @click="subscribeDuration = '12'" :class="{ 'duration-selected': subscribeDuration === '12' }" class="subscribe-plans__twelve-month">12 months</div>
        </div>
        <div class="plans">
            <div v-for="sub in subsInfo" class="plans__item">
                ...
                <div class="plans__buy">
                    <a href="#" @click.prevent="checkAuth(sub)" class="plans__buy-button black-button">Get started</a>
                </div>
            </div>
        </div>
    </div>
    ...
    data() {
        return {
            ...
            subsInfo: [
                { 
                    name: 'Basic', 
                    advantages: ['Ad-free music listening', 'Play anywhere - even offline', 'On-demand playback'],
                    price: 45
                },
                { 
                    name: 'Standart', 
